...
import type {
  IHashflowAavePortal,
  IHashflowAavePortalInterface,
} from "../../../../contracts/interfaces/xapp/IHashflowAavePortal";
...
export class IHashflowAavePortal__factory {
  static readonly abi = _abi;
  static createInterface(): IHashflowAavePortalInterface {
    return new Interface(_abi) as IHashflowAavePortalInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IHashflowAavePortal;
  }
}

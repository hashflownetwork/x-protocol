...
export interface HashflowFactoryZkSyncInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH"
      | "_poolImpl"
...
export interface HashflowFactoryZkSync extends BaseContract {
  connect(runner?: ContractRunner | null): HashflowFactoryZkSync;
  waitForDeployment(): Promise<this>;

  interface: HashflowFactoryZkSyncInterface;

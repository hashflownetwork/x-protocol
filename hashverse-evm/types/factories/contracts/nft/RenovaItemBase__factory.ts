...
import type {
  RenovaItemBase,
  RenovaItemBaseInterface,
} from "../../../contracts/nft/RenovaItemBase";
...
export class RenovaItemBase__factory {
  static readonly abi = _abi;
  static createInterface(): RenovaItemBaseInterface {
    return new Interface(_abi) as RenovaItemBaseInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): RenovaItemBase {
    return new Contract(address, _abi, runner) as unknown as RenovaItemBase;
  }
}

...
export interface RenovaItemBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface RenovaItemBase extends BaseContract {
  connect(runner?: ContractRunner | null): RenovaItemBase;
  waitForDeployment(): Promise<this>;

  interface: RenovaItemBaseInterface;

...
export interface RenovaItemSatelliteInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface RenovaItemSatellite extends BaseContract {
  connect(runner?: ContractRunner | null): RenovaItemSatellite;
  waitForDeployment(): Promise<this>;

  interface: RenovaItemSatelliteInterface;
  ...
  initialize: TypedContractMethod<
    [wormhole: AddressLike, wormholeConsistencyLevel: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  wormholeBridgeIn: TypedContractMethod<
    [wormholeVAA: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  ): TypedContractMethod<[wormholeVAA: BytesLike], [void], "nonpayable">;
  getFunction(

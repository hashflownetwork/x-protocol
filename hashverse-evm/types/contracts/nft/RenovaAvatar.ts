...
export interface RenovaAvatarInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface RenovaAvatar extends BaseContract {
  connect(runner?: ContractRunner | null): RenovaAvatar;
  waitForDeployment(): Promise<this>;

  interface: RenovaAvatarInterface;

...
export interface RenovaAvatarSatelliteInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
  ...
  encodeFunctionData(
    functionFragment: "wormholeMintReceive",
    values: [BytesLike]
  ): string;
...
export namespace XChainMintInEvent {
  export type InputTuple = [
    player: AddressLike,
    faction: BigNumberish,
    characterId: BigNumberish,
...
export interface RenovaAvatarSatellite extends BaseContract {
  connect(runner?: ContractRunner | null): RenovaAvatarSatellite;
  waitForDeployment(): Promise<this>;

  interface: RenovaAvatarSatelliteInterface;
  ...
  getFunction(
    nameOrSignature: "wormholeMintReceive"
  ...
  filters: {
    ...
    "XChainMintIn(address,uint8,uint256,uint16)": TypedContractEvent<
      ...
      XChainMintInEvent.OutputObject
    >;
    XChainMintIn: TypedContractEvent<
      XChainMintInEvent.InputTuple,
      XChainMintInEvent.OutputTuple,
      XChainMintInEvent.OutputObject
    >;

...
export interface RenovaItemInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface RenovaItem extends BaseContract {
  connect(runner?: ContractRunner | null): RenovaItem;
  waitForDeployment(): Promise<this>;

  interface: RenovaItemInterface;

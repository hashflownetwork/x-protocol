...
export interface IMockHashflowRouterInterface extends Interface {
...
export interface IMockHashflowRouter extends BaseContract {
  connect(runner?: ContractRunner | null): IMockHashflowRouter;
  waitForDeployment(): Promise<this>;

  interface: IMockHashflowRouterInterface;

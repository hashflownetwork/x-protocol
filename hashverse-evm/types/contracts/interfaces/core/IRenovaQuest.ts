...
export interface IRenovaQuestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowedTokens"
      | "depositAndEnter"
...
export interface IRenovaQuest extends BaseContract {
  connect(runner?: ContractRunner | null): IRenovaQuest;
  waitForDeployment(): Promise<this>;

  interface: IRenovaQuestInterface;

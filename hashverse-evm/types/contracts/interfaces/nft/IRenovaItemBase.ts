...
export interface IRenovaItemBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface IRenovaItemBase extends BaseContract {
  connect(runner?: ContractRunner | null): IRenovaItemBase;
  waitForDeployment(): Promise<this>;

  interface: IRenovaItemBaseInterface;

...
export interface IRenovaAvatarBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface IRenovaAvatarBase extends BaseContract {
  connect(runner?: ContractRunner | null): IRenovaAvatarBase;
  waitForDeployment(): Promise<this>;

  interface: IRenovaAvatarBaseInterface;

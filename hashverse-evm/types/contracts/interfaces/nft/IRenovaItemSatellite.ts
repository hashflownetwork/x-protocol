...
export interface IRenovaItemSatelliteInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface IRenovaItemSatellite extends BaseContract {
  connect(runner?: ContractRunner | null): IRenovaItemSatellite;
  waitForDeployment(): Promise<this>;

  interface: IRenovaItemSatelliteInterface;

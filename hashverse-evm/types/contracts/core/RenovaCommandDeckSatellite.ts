...
export interface RenovaCommandDeckSatellite extends BaseContract {
  connect(runner?: ContractRunner | null): RenovaCommandDeckSatellite;
  waitForDeployment(): Promise<this>;

  interface: RenovaCommandDeckSatelliteInterface;
